...
import static com.example.server.enumaration.Status.SERVER_DOWN;
...
@Service
@Transactional
@Slf4j // this allows us to print smth in console, so we can exactly see what happening
public class ServerServiceImpl implements ServerService {
    ...
    public Server get(Long id) {
        ...
        return serverRepo.findById(id).orElseThrow(() -> new ServerNotFoundException("Server with id- " + id + " not found"));
    }
